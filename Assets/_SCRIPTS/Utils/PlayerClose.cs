...
namespace Destrial
{
    public class PlayerClose : MonoBehaviour
    {
        ...
        {
            PlayerManager player=GetClosestPlayerInRadius(TestRadius);
        ...
        private PlayerManager GetClosestPlayerInRadius(float radius)
        {
            ...
            foreach (Collider2D hit in hits)
            {
                ...
                PlayerManager rat = hit.GetComponentInParent<PlayerManager>();
                if (rat != null)
                {
